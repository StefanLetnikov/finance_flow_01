import 'package:finance_flow_01/bar%20graph/bar_graph.dart';
...
class ExpenseSummary extends StatelessWidget{
  ...
  //calcualte max y amount in bar graph
  double calcualteMax(ExpenseData value,
      String monday,
      String tuesday,
      String wednesday,
      String thursday,
    ...
    //sort ascending
    values.sort();
    //get largest amount and increase the cap slightly so the graph looks almost full
    max = values.last * 1.1;
      ...
      builder: (context, value, child) => Column(
        children: [
          ...
          SizedBox(
            height: 200,
            child: MyBarGraph(
              maxY: calcualteMax(value, monday, tuesday, wednesday, thursday, friday, saturday, sunday),
